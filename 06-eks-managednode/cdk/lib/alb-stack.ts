...
export class AlbStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AlbStackProps) {
    ...
    this.alb.logAccessLogs(this.accessLogsBucket, "alb-access");

    this.targetGroup = new elbv2.ApplicationTargetGroup(this, "OrdersTg", {
      targetGroupName: "orders-app-eks-tg",
      vpc: props.vpc,
      port: props.config.appPort,
    ...
    const webAcl = new wafv2.CfnWebACL(this, "OrdersAlbWebAcl", {
      ...
      visibilityConfig: {
        ...
        metricName: "orders-eks-alb-webacl",
    ...
    new cdk.CfnOutput(this, "AlbAccessLogsBucketName", { value: this.accessLogsBucket.bucketName });
  }
}
